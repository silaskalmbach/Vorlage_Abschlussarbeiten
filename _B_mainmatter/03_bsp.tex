...
Empfohlen wird die Plots als SVG zu speichern. Diese können dann bei Bedarf in Inkscape nachbearbeitet werden. 
...
Prinzipiell kann die SVG-Grafik direkt wie folgt eingebunden werden:
