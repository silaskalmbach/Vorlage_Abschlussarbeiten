...
Es gibt mehrere Möglichkeiten Diagramme und Grafiken zu erstellen und in  \LaTeX einzubinden. Im folgenden wird die Erstellung von \nameref{subsec:python_inkscape} sowie die Erstellung von \nameref{subsec:tikz} erläutert.
...
\begin{table}[h!]
	...
	]{_B_mainmatter/data/Example2.csv}{}%
...
\begin{figure}[h!]
	...
	\begin{tikzpicture}
		\begin{axis}[
			...
			\addplot table [x=Strecke, y=Breite1, col sep=comma] {_B_mainmatter/data/Example2.csv};
			\addplot table [x=Strecke, y=Breite2, col sep=comma] {_B_mainmatter/data/Example2.csv};
			\addplot table [x=Strecke, y=Breite3, col sep=comma] {_B_mainmatter/data/Example2.csv};
