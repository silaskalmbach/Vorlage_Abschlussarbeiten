...
\include{_B_mainmatter/01_bsp}      % Grundlagen
\include{_B_mainmatter/02_bsp}      % Tabellen
\include{_B_mainmatter/03_bsp}      % Abbildungen
\include{_B_mainmatter/04_bsp}      % Formeln
\include{_B_mainmatter/05_bsp}      % Nomenklatur
\include{_B_mainmatter/06_bsp}      % Erweiterte Formatierung
\include{_B_mainmatter/07_bsp}      % Farbschema
\include{_B_mainmatter/08_bsp}      % Programmcode
