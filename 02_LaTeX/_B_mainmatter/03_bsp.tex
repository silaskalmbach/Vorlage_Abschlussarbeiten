...
Empfohlen wird die Plots als \gls{SVG} zu speichern. Diese können dann bei Bedarf in Inkscape (\url{https://inkscape.org/de/}) nachbearbeitet werden. 
