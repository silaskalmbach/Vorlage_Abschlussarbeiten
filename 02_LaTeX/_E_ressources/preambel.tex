...
\usepackage[%
    ...
    xindy={language=german-duden,codepage=utf8}, % xindy zum Indexieren verwenden -> Muss vorher installiert werden (https://www.activestate.com/products/perl/)
    % xindy={language=german,codepage=duden-utf8}, Falls Fehler bzgl. Sprache auftreten
