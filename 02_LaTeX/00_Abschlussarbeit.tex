...
\usepackage{graphicx, subfig} %Einbinden von Bildern, Bilder nebeneinander
...
% sorting=nyt,									% Sortierung des Verzeichnis Autor, Titel, Jahr
...
\include{10_bsp} %durch Eigene Kapitel erstezen
%\include{11_bsp}
\include{12_bsp}
\include{13_bsp}
\include{14_bsp}
...
%{
%\chapter*{Digitale Form der Ausarbeitung}
%\thispagestyle{empty}}
